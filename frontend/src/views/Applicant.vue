        ...
        <div class="card">
          ...
          <form class="card-body" @submit.prevent="onSearch">
            ...
            <div class="form-check">
              <input id="a-s0" class="form-check-input" type="checkbox" v-model="filters.stage.review" />
              <label class="form-check-label text-sm" for="a-s0">검토</label>
            </div>
            <div class="form-check">
              <input id="a-s1" class="form-check-input" type="checkbox" v-model="filters.stage.wait" />
              <label class="form-check-label text-sm" for="a-s1">대기</label>
            </div>
            <div class="form-check">
              <input id="a-s2" class="form-check-input" type="checkbox" v-model="filters.stage.apply" />
              <label class="form-check-label text-sm" for="a-s2">신청</label>
            </div>
            <div class="form-check">
              <input id="a-s3" class="form-check-input" type="checkbox" v-model="filters.stage.approve" />
              <label class="form-check-label text-sm" for="a-s3">승인</label>
            </div>
            <div class="form-check">
              <input id="a-s4" class="form-check-input" type="checkbox" v-model="filters.stage.reject" />
              <label class="form-check-label text-sm" for="a-s4">반려</label>
            </div>
