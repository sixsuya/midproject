...
<template>
  <div class="rank-detail">
    ...
    <div class="rank-detail-block mb-3">
      ...
      >
        <span class="rank-pill rank-pill-plan" rank-code="d0_20">계획</span>
        <span class="rank-pill rank-pill-focus" rank-code="d0_30">중점</span>
        <span class="rank-pill rank-pill-urgent" rank-code="d0_40">긴급</span>
      </div>
    </div>
    <!-- 기관담당자가 우선순위 선택 후 사유 입력. 로그인 연동 시 member_role === 'a0_30' 조건 추가 -->
    <div
      v-if="rank_code === 'd0_20' || rank_code === 'd0_30' || rank_code === 'd0_40'"
      class="rank-detail-block"
    >
      <textarea
        v-model="rank_comment"
